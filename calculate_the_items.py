                    ...
                    for key in reversed(keys):
                        ...
                        if data['assets'][key]['regions']:
                            for i in range(len(data['assets'][key]['regions'])):
                                b.append([int(data['assets'][key]['regions'][i]['points'][0]['y']),
                                          int(data['assets'][key]['regions'][i]['points'][0]['x']),
                                          int(data['assets'][key]['regions'][i]['points'][2]['y']),
                                          int(data['assets'][key]['regions'][i]['points'][2]['x'])])
